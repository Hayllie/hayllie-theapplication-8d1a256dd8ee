...
public class local7walatActivity extends AppCompatActivity {

    public void gotopersonaltype (View view){
        Intent intent = new Intent(getApplicationContext(),local7walat2Activity.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slideinleft, R.anim.slideoutright);

    }
    public void gotobranchtype (View view){
        Intent intent = new Intent(getApplicationContext(),local7walat3Activity.class);
        startActivity(intent);
        overridePendingTransition(R.anim.slideinleft, R.anim.slideoutright);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local7walat);
